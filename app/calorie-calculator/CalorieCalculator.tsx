...
export default function CalorieCalculator() {
  ...
  const calculateCalories = (isUser: boolean = false) => {
    ...
    const bmr =
      gender === "male"
        ? 88.362 +
          13.397 * convertedWeight +
          4.799 * convertedHeight -
          5.677 * age
        : 447.593 +
          9.247 * convertedWeight +
          3.098 * convertedHeight -
          4.33 * age;
    ...
    if (isUser) {
      ...
      if (typeof window !== "undefined" && window.gtag) {
        window.gtag("event", "calculate_calories", {
          event_category: "Calorie Calculator",
          event_label: "Calorie Calculation",
          value: age + "-" + gender,
        });
      }
    }
    ...
    <div className="max-w-4xl mx-auto p-4 lg:p-6 bg-white rounded-lg shadow-md flex flex-col lg:flex-row">
      ...
      <div className="w-full lg:w-1/2 lg:pr-6">
        <div className="space-y-4">
          ...
          {/* Calculate Button */}
          <button
            onClick={() => calculateCalories(true)}
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-100 p-4 rounded-lg">
              ...
              <p className="text-blue-600 text-lg">
                {calories.maintain} calories/day
              </p>
